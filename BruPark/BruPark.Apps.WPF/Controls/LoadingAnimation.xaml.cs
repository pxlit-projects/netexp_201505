...
namespace BruPark.Apps.WPF.Controls
{
    /// <summary>
    ...
    public partial class LoadingAnimation : UserControl
    {
        public static readonly DependencyProperty MaximumProperty =
            DependencyProperty.Register("Maximum", typeof(int), typeof(LoadingAnimation), new UIPropertyMetadata(1));

        public static readonly DependencyProperty MinimumProperty =
            DependencyProperty.Register("Minimum", typeof(int), typeof(LoadingAnimation), new UIPropertyMetadata(1));

        public static readonly DependencyProperty ValueProperty =
            DependencyProperty.Register("Value", typeof(int), typeof(LoadingAnimation), new UIPropertyMetadata(100));
